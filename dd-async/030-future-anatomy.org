...
* Lifecycle
  ...
  file:imgs/gen/future-lifecycle.png
...
* Writing a simple future
  ...
  A simple future which will never complete
   ...
   #+INCLUDE: "exercises/future-anatomy/src/never.rs" src rust
...
* Await progress
  ...
  #+INCLUDE: "exercises/future-anatomy/src/bin/01_never.rs" src rust
...
* A more useful future
  ...
  #+INCLUDE: "exercises/future-anatomy/src/twice.rs" src rust
...
* Not so useful...
  ...
  #+BEGIN_SRC console
    ❤ (tempest) ~/P/t/t/d/e/future-anatomy> cargo run --bin 02_twice
     Compiling future-anatomy v0.1.0 (/home/Projects/talks/teaching-rust/dd-async/exercises/future-anatomy)
...
* We need to wake our future again
  ...
  #+INCLUDE: "exercises/future-anatomy/src/good_twice.rs" src rust
...
* 
  ...
  #+BEGIN_SRC console
     ❤ (tempest) ~/P/t/t/d/e/future-anatomy> cargo run --bin 03_twice
